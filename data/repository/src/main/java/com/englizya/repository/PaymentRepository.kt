...
interface PaymentRepository {
    ...
    suspend fun requestFawryPayment(request: FawryInvoice): Result<FawryPaymentResponse>
    suspend fun requestFawryPaymentOrder(request: FawryPaymentOrderRequest, token: String): Result<Any?>
}