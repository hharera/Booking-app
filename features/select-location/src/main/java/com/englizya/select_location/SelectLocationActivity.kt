...
class SelectLocationActivity : BaseActivity(), OnMapReadyCallback {
    ...
    private lateinit var bind: ActivitySelectLocationBinding
    private lateinit var selectLocationViewModel: SelectLocationViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivitySelectLocationBinding.inflate(layoutInflater)
        selectLocationViewModel = ViewModelProvider(this).get(SelectLocationViewModel::class.java)
    ...
    private fun setupObserver() {
        selectLocationViewModel.location.observe(this) {
            position = it
        }
    }
...
//        }
    ...
    private fun setupMapListener() {
        map.setOnMapClickListener {
            selectLocationViewModel.setLocation(it)
            updateMapUI()
        }
    }
            ...
            locationResult.addOnCompleteListener(this) {
                ...
                if (it.isSuccessful) {
                    ...
                    if (lastKnownLocation != null) {
                        ...
                        selectLocationViewModel.setLocation(position)
                        updateMapUI()
                    }
                } else {
    ...
    private fun updateMapUI() {
        ...
        map.addMarker(
            MarkerOptions()
                ...
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.map_marker_home))
        )
    ...
    private fun backWithResult() {
        ...
        returnIntent.putExtra(Arguments.SELECTED_LOCATION, position)
